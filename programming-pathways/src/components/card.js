      ...
      <div className= "flex justify-between">
        <div className='p-3'>
          ...
          <img src= "https://www.google.com/favicon.ico" className='w-6 h-6'></img>
            ...
            <div>
              <h1 class = "text-slate-900 font-semibold px-2">Hello World!</h1>
              <h2 class = "text-gray-500 font-semibold px-2 text-sm">Some Test Description</h2>
              <a href= "https://google.com" className="text-blue-500 font-semibold underline px-2 text-sm">https://google.com</a>
            </div>
          </div>
        </div>
        <div className = "flex justify-center items-center">
        <h1 class = "text-blue-500 font-semibold px-2 text-2xl"> 61</h1>
