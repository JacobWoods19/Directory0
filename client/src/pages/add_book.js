...
class AddBook extends React.Component{
    ...
    render() {
       return(
        <div className='p-5'>
            <h1 className='text-2xl py-3 font-bold '>Add Book</h1>
        <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200">
            ...
            <li>
                <a href="/add_book" class="inline-block text-blue-600 bg-gray-100 p-4 rounded-t-lg hover:bg-gray-50 active">Book</a>
            </li>
            <li>
        ...
        <div class="mb-6">
            <label for="url" class="block mb-2 text-sm font-medium text-gray-900">Purchase URL</label>
        ...
        <div class="mb-6">
            <label for="description" class="block mb-2 text-sm font-medium text-gray-900">Book Description</label>
        ...
        <div class="mb-6">
            <label for="description" class="block mb-2 text-sm font-medium text-gray-900" >Book Tags (Comma Separated)</label>
