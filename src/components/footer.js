...
<footer class="p-4 bg-slate-800 md:p-6">
    ...
    <hr class="my-6 border-gray-200 mx-0 md:mx-auto dark:border-gray-700 lg:my-8" />
    <div class="flex items-center justify-between">
        <span class="text-sm text-gray-500 text-center dark:text-gray-400">© 2023 Directory0.Org . All Rights Reserved.
        </span>
    </div>
</footer>
